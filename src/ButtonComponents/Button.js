...
import mario1 from "../photos/mario1.png";
import mario2 from "../photos/mario2.png";
...
const Button = () => {
  ...
  const [SunZoom, setSunZoom] = useState(
    "md:h-96 absolute md:left-[30%] md:right-[30%]"
  );
  const buttonClicked = () => {
    ...
    setTimeout(function () {
      ...
      setSunZoom("md:h-96 absolute md:left-[30%] md:right-[30%] zoom-image");
    }, 14000);
    setTimeout(function () {
      setPage3(true);
      SetBackgoundPage3("h-screen bg-[#FFFF00]");
    }, 16000);
    setTimeout(function () {
  ...
  return (
    <>
      {!clicked ? (
        ...
        <>
          <div className="h-screen w-screen bg-[url('./photos/fundalMario.png')] bg-cover relative">
            <img
              src={bird}
              alt="da"
        ...
        <>
          <div className="h-screen relative">
            ...
            <img src={sun} alt="sun" className={SunZoom} />
